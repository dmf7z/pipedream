...
require.register("client/client-app", function(module, exports, require){
...
require.register("client/router", function(module, exports, require){
//Put here routes for client that you do not want to expose in client
});
require.register("controllers/router", function(module, exports, require){
var _ = require('lodash');
...
require.register("model/dummy", function(module, exports, require){
module.exports = [
  {
    id: 'pa',
    name: 'Page A',
...
require.register("node_modules/pipedream/lib/build/buildclient", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var fs = require('fs'),
    path = require('path'),
    debug = require('debug')('buildclient');
...
// e.g. buildclient(paths, options).set(key, val).include(paths).render(fn)
exports = module.exports = render;
// e.g. buildclient.render(paths, options, fn)
exports.render = render;

});
require.register("node_modules/pipedream/lib/build/require", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
...
require.register("node_modules/pipedream/lib/collection/client/collection", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
...
require.register("node_modules/pipedream/lib/collection/collection.base", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
...
// If models tend to represent a single row of data, a Pipedream Collection is
...
_.extend(BaseCollection.prototype, Pipedream.Events, {  
  ...
  // Proxy `Pipedream.sync` by default.
  sync: function() {
    return Pipedream.sync.apply(this, arguments);
  },
...
// 90% of the core usefulness of Pipedream Collections is actually implemented
// right here:
...
BaseCollection.extend = helper.extend;

module.exports = BaseCollection;
});
require.register("node_modules/pipedream/lib/helper/helper", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
...
require.register("node_modules/pipedream/lib/model/client/model", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
var helper = require('../../helper/helper'); 
...
ClientModel.extend = helper.extend;
...
require.register("node_modules/pipedream/lib/model/model.base", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
var Pipedream = require('../pipedream.base');
var helper = require('../helper/helper'); 
...
// Pipedream **Models** are the basic data object in the framework --
...
_.extend(BaseModel.prototype, Pipedream.Events, {
  ...
  // Proxy `Pipedream.sync` by default -- but override this if you need
  ...
  // using Pipedream's restful methods, override this to change the endpoint
  // that will be called.
  url: function() {
    var base = _.result(this, 'urlRoot') || _.result(this.collection, 'url') || helper.urlError();
...
BaseModel.extend = helper.extend;

module.exports = BaseModel;

});
require.register("node_modules/pipedream/lib/pipedream.base", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var helper = require('./helper/helper'); 
...
(function(){
  ...
  //
  //     var object = {};
  //     _.extend(object, Pipedream.Events);
  //     object.on('expand', function(){ alert('expanded'); });
  //     object.trigger('expand');
  //
  var Events = Pipedream.Events = {
  ...
  // Pipedream events have 3 arguments).
  ...
  var History = Pipedream.History = function() {
    this.handlers = [];
  ...
  // Set up all inheritable **Pipedream.History** properties and methods.
  _.extend(History.prototype, Events, {
    ...
    start: function(options) {
      if (History.started) throw new Error("Pipedream.history has already been started");
      ...
      if (oldIE && this._wantsHashChange) {
        this.iframe = Pipedream.$('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo('body')[0].contentWindow;
      ...
      if (this._hasPushState) {
        Pipedream.$(window).on('popstate', this.checkUrl);
      } else if (this._wantsHashChange && ('onhashchange' in window) && !oldIE) {
        Pipedream.$(window).on('hashchange', this.checkUrl);
    ...
    // Disable Pipedream.history, perhaps temporarily. Not useful in a real app,
    // but possibly useful for unit testing Routers.
    stop: function() {
      Pipedream.$(window).off('popstate', this.checkUrl).off('hashchange', this.checkUrl);
    ...
    //Used to match first view events
    firstLoad: true,
    ...
    loadUrl: function(fragmentOverride) {
      ...
      var matched = _.any(this.handlers, function(handler) {
        if (handler.route.test(fragment)) {
          ...
          if(Pipedream.history.firstLoad)
            Pipedream.history.firstLoad = false;
          return true;
        }
      });
      return matched;
  ...
  Pipedream.history = new History;

  // Helpers
  // -------

  // Set up inheritance for the model, collection, router, view and history.
  History.extend = helper.extend;

  

}).call(this);
});
require.register("node_modules/pipedream/lib/router/client/router", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
var helper = require('../../helper/helper'); 
...
require.register("node_modules/pipedream/lib/router/router.base", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
var Pipedream = require('../pipedream.base');
var helper = require('../helper/helper'); 
...
require.register("node_modules/pipedream/lib/sync/client/sync", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
var helper = require('../../helper/helper'); 
var BaseSync = require('../sync.base');

var ClientSync = BaseSync.extend({
...
ClientSync.extend = helper.extend;

module.exports = ClientSync;

});
require.register("node_modules/pipedream/lib/sync/sync.base", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
var Pipedream = require('../pipedream.base');
var helper = require('../helper/helper'); 
...
require.register("node_modules/pipedream/lib/view/client/view", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
var Pipedream = require('../../pipedream.base');
var helper = require('../../helper/helper'); 
...
require.register("node_modules/pipedream/lib/view/view.base", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
var _ = require('lodash');
var Pipedream = require('../pipedream.base');
var helper = require('../helper/helper'); 
...
require.register("node_modules/pipedream/pipedream.client", function(module, exports, require){
var jQuery = require("jquery"); this.jQuery = jQuery;
...
require.register("templates/compiled/layout", function(module, exports, require){
(function() {
...
require.register("templates/compiled/page-buttons", function(module, exports, require){
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
...
require.register("templates/compiled/page", function(module, exports, require){
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
...
require.register("templates/compiled/pages", function(module, exports, require){
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
...
require.register("templates/compiled/section-buttons", function(module, exports, require){
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
...
require.register("templates/compiled/section", function(module, exports, require){
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
...
require.register("templates/compiled/sections", function(module, exports, require){
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
...
require.register("views/page", function(module, exports, require){
var _ = require('lodash')
...
require.register("views/pages", function(module, exports, require){
var _ = require('lodash')
...
require.register("views/section", function(module, exports, require){
var _ = require('lodash')
...
require.register("views/sections", function(module, exports, require){
var _ = require('lodash')
